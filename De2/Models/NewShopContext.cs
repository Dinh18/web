...
namespace De2.Models
{
    public partial class NewShopContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=THEDINH\\SQLEXPRESS;Initial Catalog=NewShop;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
            }
        }
